    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <div className="bg-stone-50 border-b border-stone-100 py-3 md:py-6">
        <div className="container mx-auto px-4 flex items-center justify-between gap-2 min-h-[52px] md:min-h-0">
          <Link to="/" className="inline-flex items-center min-h-[44px] min-w-[44px] -ml-2 pl-2 pr-2 text-stone-500 hover:text-stone-900 transition-colors font-medium text-sm group touch-manipulation cursor-pointer" aria-label="Back to home">
          ...
          <Link to="/" className="font-serif text-xl sm:text-2xl font-semibold tracking-tight text-stone-900 hover:text-stone-700 transition-colors py-2 px-1 min-h-[44px] inline-flex items-center touch-manipulation cursor-pointer">
            Style Forage
          </Link>
